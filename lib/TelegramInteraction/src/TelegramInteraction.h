...
public:
    TelegramInteraction(WiFiClientSecure *client);
...
private:
    ...
    void getActuatorsStatusMessage(String chatId, std::vector<Actuator *> *actuators, String *message);
};
